...
String SendHTML()
{
  ...
  ptr += "<form action=""/"" method=""post"">\n";
      ...
      ptr += "<table>\n";
          ptr += "<tr>\n";
              ptr += "<th><label for=""voltsPerPoint"">mVolts/point </label><br><input type=""text"" id=""voltsPerPoint"" name=""voltsPerPoint"" value=""";
                dtostrf(sensors.VoltsPerPoint,8, 4, ptr1);
                ptr += String(ptr1);
                ptr += """></th>\n";
              ptr += "<th><label for=""ampsPerPoint"">mAmps/point </label><br><input type=""text"" id=""ampsPerPoint"" name=""ampsPerPoint"" value=""";
                dtostrf(sensors.AmpsPerPoint,8, 4, ptr1);
                ptr += String(ptr1);
                ptr += """></th>\n";
          ptr += "</tr>\n";
          ptr += "<tr>\n";
            ptr += "<th>Max Voltage:";
              ...
              ptr += "V</th>";
            ptr += "<th>Max Amps:";
              dtostrf(sensors.AmpsPerPoint / 1000.00 * 4095.00, 6, 2, ptr2);
              ptr += ptr2;
              ptr += "A</th>";
          ptr += "</tr>\n";
      ptr += "</table>\n";
